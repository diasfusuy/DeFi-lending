...
/**
 * @title MockUSDC
 * @notice Mock ERC20 token representing a USD stablecoin for local testing and development.
 * @dev
...
/**
 * @notice Creates the MockUSDC token and sets the initial owner.
...
/**
 * @notice Mints new MockUSDC tokens to a specified address.
